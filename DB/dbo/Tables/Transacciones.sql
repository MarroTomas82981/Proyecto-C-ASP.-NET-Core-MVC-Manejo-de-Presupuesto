CREATE TABLE [dbo].[Transacciones] (
    ...
    CONSTRAINT [FK_Transacciones_Transacciones] FOREIGN KEY ([Id]) REFERENCES [dbo].[Transacciones] ([Id]),
    CONSTRAINT [FK_Transacciones_Transacciones1] FOREIGN KEY ([Id]) REFERENCES [dbo].[Transacciones] ([Id]),
